  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10">
      <div className="w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto">
        <div className="mb-10 w-full flex items-start flex-wrap gap-4">
          <button
            onClick={() => navigate("/")}
          ...
          <div>
            ...
            <p className="text-gray-500 mt-2">
              Track your past interviews and review your performance to improve
              for the future.
            </p>
          </div>
        </div>
        {interviews.length === 0 ? (
          <div className="bg-white p-10 rounded-2xl shadow text-center">
            <p className="text-gray-500">
              No interviews found. Start your interview journey now and see your
              history here!
            </p>
          </div>
        ) : (
